...
class Products(models.Model):
    ...
    Product_slide = models.ImageField(upload_to='Products', max_length=200)
    Product_slide2 = models.ImageField(upload_to='Products', max_length=200)
    created_date = models.DateTimeField(default=timezone.now)

    def delete(self, *args, **kwargs):
        # object is being removed from db, remove the file from storage first
        self.Product_img.delete()
        self.Product_slide.delete()
        self.Product_slide2.delete()
